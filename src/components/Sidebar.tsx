...
const getMenuItems = (viewMode: 'instructor' | 'user' | 'superadmin') => {
  ...
  const allItems = [
    ...
    { title: "Notes", icon: StickyNote, path: "/notes", visibleFor: ['instructor'] },
    { title: "Ingressos", icon: Euro, path: "/income", visibleFor: ['instructor'] },
    { title: "Estadístiques", icon: BarChart3, path: viewMode === 'user' ? "/userstats" : "/stats", visibleFor: ['instructor', 'user'] },
