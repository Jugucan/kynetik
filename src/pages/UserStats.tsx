...
const UserStats = () => {
    ...
    return (
      <div className="space-y-4 px-4 max-w-3xl mx-auto">
        ...
        <div className="p-8 bg-muted/30 rounded-lg text-center">
          <p className="text-muted-foreground text-sm">Encara no tens sessions registrades.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto pb-8">
      ...
      {/* CAPÇALERA — mateix estil que UserDetailModal */}
      <div className="px-4 sm:px-6 pt-4 pb-4 mb-4 bg-gradient-to-r from-primary/5 to-primary/10 rounded-xl">
        <div className="flex items-center gap-4">
          {(currentUserData.profileImageUrl || currentUserData.avatar) && (
            <img
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold">{currentUserData.name}</h1>
            <p className="text-sm text-muted-foreground mb-2">Les meves Estadístiques</p>
      ...
      {/* PESTANYES — mateix patró que UserDetailModal */}
          ...
          <TabsContent value="stats" className="space-y-4 pb-6">
            <ScrollArea className="h-[65vh] pr-4">
              <div className="space-y-6">
                ...
                {/* Resum General — targetes amb gradients com al modal */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div className="p-3 sm:p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-neo text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-purple-700">{currentUserData.daysSinceLastSession || 0}</div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {stats.generalRanking.total > 0 && (
                        <div className="text-right">
                          <div className="text-xs text-indigo-600">de {stats.generalRanking.total} usuaris</div>
                        </div>
                      )}
                    </div>
                  </div>
