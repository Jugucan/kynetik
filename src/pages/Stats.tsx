    ...
    <TooltipProvider>
      <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          <Tooltip>
            <TooltipTrigger asChild>
              <NeoCard className="p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-blue-100 cursor-help">
                <div className="flex items-center gap-3">
            ...
            <TooltipContent>
              <p className="max-w-xs">Total de persones diferents que han vingut a les teves classes</p>
            </TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <NeoCard className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-green-100 cursor-help">
                <div className="flex items-center gap-3">
            ...
            <TooltipContent>
              <p className="max-w-xs">Total de classes que has impartit segons el teu calendari (excloent vacances i festius)</p>
            </TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <NeoCard className="p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-purple-100 cursor-help">
                <div className="flex items-center gap-3">
            ...
            <TooltipContent>
              <p className="max-w-xs">Mitjana de persones que assisteixen a cada classe (total assistències ÷ total classes)</p>
            </TooltipContent>
          </Tooltip>

          <Tooltip>
            <TooltipTrigger asChild>
              <NeoCard className="p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-orange-100 cursor-help">
                <div className="flex items-center gap-3">
            ...
            <TooltipContent>
              <p className="max-w-xs">Usuaris que han vingut almenys una vegada en els últims 30 dies</p>
            </TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <Tooltip>
            <TooltipTrigger asChild>
              <NeoCard className="p-3 sm:p-4 cursor-help">
            ...
            <TooltipContent>
              <p className="max-w-xs">Percentatge d'usuaris que han vingut més d'una vegada. Indica la fidelitat dels teus alumnes. ({stats.recurrentUsers} de {stats.totalUsers} usuaris han repetit)</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>
              <p className="max-w-xs">Comparació del nombre de classes entre el mes actual i l'anterior. Un valor positiu indica que has fet més classes aquest mes</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>
              <p className="max-w-xs">Dia de la setmana en què fas més classes</p>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>
              <p className="max-w-xs">Franja horària on fas més classes (Matí: abans 12h, Tarda: 12-18h, Vespre: després 18h)</p>
            </TooltipContent>
          </Tooltip>
        </div>
